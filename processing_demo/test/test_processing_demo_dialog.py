...
__author__ = 'qgis-plugin@jsonsingh.com'
__date__ = '2026-07-03'
__copyright__ = 'Copyright 2026, jsonsingh.com'
...
class processing_demoDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = processing_demoDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(processing_demoDialogTest)
